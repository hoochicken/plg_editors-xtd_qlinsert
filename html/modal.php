...
<div class="container">
    ...
    <ul>
        ...
        foreach ($arr as $k => $v):
            ...
            ?>
            <li><a href="#" class="btn" onclick="window.parent.insertQlinsert('<?php echo $destination; ?>', <?php echo 'v' . $v; ?>)"><?php echo $label; ?></a> <?php echo substr(strip_tags($params->get($v)), 0, 25); ?>...</li>
        <?php endforeach; ?>
    </ul>
</div>
</body>
